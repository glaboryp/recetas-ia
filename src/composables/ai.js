...
export async function useCreateRecipe(ingredients, persons, time, lunch) {
  ...
  Empieza tu respuesta ÚNICAMENTE con el nombre de la receta en negrita, sin ninguna etiqueta ni palabra antes (nada de "Nombre de la receta:" ni similares), por ejemplo: **Tostada de tomate**.
